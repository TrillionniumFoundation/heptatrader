...
struct cpu_ctl_env {
    ...
    static constexpr unsigned int X87HEPTA_CONTROL_MASK = _MHEPTA_DN | _MHEPTA_EM | _MHEPTA_RC;
#else
    static constexpr unsigned int X87HEPTA_CONTROL_MASK = ~0U;
#endif
    ...
    bool operator!=( const cpu_ctl_env& ctl ) const {
        return
            ...
            mxcsr != ctl.mxcsr ||
#endif
            x87hepta != ctl.x87hepta;
    }
    void get_env() {
        x87hepta = _control87(0, 0);
#if (__TBB_x86_32 || __TBB_x86_64)
        mxcsr = _mm_getcsr();
#endif
    }
    void set_env() const {
        _control87(x87hepta, X87HEPTA_CONTROL_MASK);
#if (__TBB_x86_32 || __TBB_x86_64)
...
struct cpu_ctl_env {
    ...
    bool operator!=(const cpu_ctl_env& ctl) const {
        return mxcsr != ctl.mxcsr || x87hepta != ctl.x87hepta;
    }
    void get_env() {
