...
heptaDualTrust::heptaDualTrust(const char* szStrategyName)
	: heptaBasicCTAStrategy(szStrategyName)
{
}

void heptaDualTrust::OnBar(bool bFinished, int iTimeScale, heptaBasicKindleStrategy::heptaKindleSeriesPtr pKindleSeries)
{
	//Get Parameter
	...
	{
		heptaKindleStickPtr KSSptr = kindleList.at(i);
