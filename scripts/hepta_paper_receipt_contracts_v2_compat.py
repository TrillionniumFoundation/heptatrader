...
BINDINGS_SCHEMA = "hepta.paper-receipt-bindings.v2"
EVIDENCE_BINDINGS_SCHEMA = "hepta.paper-receipt-evidence-bindings.v2"
DECISION_SCHEMA = "hepta.paper-decision-receipt.v2"
CYCLE_SCHEMA = "hepta.paper-cycle-receipt.v2"
VERSION = 2
MAX_BYTES = 1024 * 1024
...
PHASE_TOOL_NAMES = {
    ...
    "CLEANUP": frozenset({
        ...
        "risk.get_limits", "campaign.status",
    }),
