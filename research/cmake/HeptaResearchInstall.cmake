...
if(UNIX)
    ...
    install(PROGRAMS model_manifest.py DESTINATION "${CMAKE_INSTALL_BINDIR}"
        RENAME hepta-research-models COMPONENT ResearchSDK)
endif()
install(FILES LEGACY-BUNDLE.md MODELS.md MODEL-CLI.md DESTINATION "${CMAKE_INSTALL_DATADIR}/HeptaResearch" COMPONENT ResearchSDK)
