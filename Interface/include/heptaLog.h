...
#define hepta_LOG_DATATYPE_LENGTH 16
#define hepta_LOG_TIME_LENGH 18
#define hepta_LOG_DATAMSG_LENGTH 4058


struct LogData
{
	int	 DataType;
	char szDataType[hepta_LOG_DATATYPE_LENGTH];
	char szTime[hepta_LOG_TIME_LENGH];	//20170309_00:00:00
	char szDataMsg[hepta_LOG_DATAMSG_LENGTH];
...
{
public:
	heptaLog(const char * pFileName, const char * pFolder = NULL, bool bTimeInName = true);
	~heptaLog();
