...
public:
	...
	virtual int ReqOrderInsert(heptaOrderPtr pOrder) { return 0; }
	virtual int CancelOrder(heptaOrderPtr pOrder) { return 0; }

	virtual heptaHeptaTrader::heptaDate GetTradingDay() = 0;
