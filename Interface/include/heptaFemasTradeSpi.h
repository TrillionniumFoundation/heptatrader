...
#define HEPTA_USING_AUTHCODE

#ifdef _MSC_VER
#ifdef HEPTA_USING_AUTHCODE
#pragma comment(lib, "USTPtraderapiAF.lib")
#else
#pragma comment(lib, "USTPtraderapiAF.lib")
#endif // HEPTA_USING_AUTHCODE

#endif // _MSC_VER



class heptaFemasTradeSpi 
...
public:
	...
	virtual heptaOrderPtr InputFOKOrder(const char * szInstrumentID, heptaFtdcDirectionType direction,
		heptaOpenClose openclose, int volume, double price);
#if 0
	virtual void InputOrder(heptaOrderPtr pOrder);
#endif
...
protected:
	...
	bool		AddMyReqToList(heptaReqType nType);

#ifdef _MSC_VER
#pragma region CTPDefine2HEPTADefine
#endif // _MSC_VER
	heptaFtdcDirectionType			GetFemas2HeptaDirectionType(TUstpFtdcDirectionType direction);
	heptaFtdcHedgeFlagType			GetFemas2HeptaHedgeFlagType(TUstpFtdcHedgeFlagType hedge);
	heptaFtdcOffsetFlagType		GetFemas2HeptaOffsetFlagType(TUstpFtdcOffsetFlagType Offset);
	heptaFtdcOrderPriceType		GetFemas2HeptaOrderPriceType(TUstpFtdcOrderPriceTypeType orderpricetype);
	heptaFtdcTimeConditionType		GetFemas2HeptaTimeConditionType(TUstpFtdcTimeConditionType timeconditiontype);
	heptaFtdcVolumeConditionType	GetFemas2HeptaVolumeConditionType(TUstpFtdcVolumeConditionType volumeconditiontype);
	heptaFtdcForceCloseReasonType	GetFemas2HeptaForceCloseReasonType(TUstpFtdcForceCloseReasonType forceclosereasontype);
	heptaFtdcOrderSourceType		GetFemas2HeptaOrderSourceType(TUstpFtdcOrderSourceType ordersource);
	heptaFtdcOrderStatusType		GetFemas2HeptaOrderStatusType(TUstpFtdcOrderStatusType orderstatustype);
	heptaFtdcOrderTypeType			GetFemas2HeptaOrderTypetype(TUstpFtdcOrderTypeType ordertype);
	heptaFtdcInstrumentStatusType	GetFemas2HeptaInstrumentStatusType(TUstpFtdcInstrumentStatusType intrumentstatustype);

	TUstpFtdcDirectionType		GetHepta2FemasDirectionType(heptaFtdcDirectionType direction);

	heptaOrderPtr					GetheptaOrderPtr(CUstpFtdcOrderField * pOrder);
	heptaOrderPtr					GetheptaOrderPtr(CUstpFtdcInputOrderField * pInputOrder);
	heptaTradePtr					GetheptaTradePtr(CUstpFtdcTradeField * pTrade);
#ifdef _MSC_VER
#pragma endregion
#endif // _MSC_VER
...
protected:
	...
	std::deque<heptaReqType>		m_PrioritizedReqList;
	...
	HEPTA_DISALLOW_COPYCTOR_AND_ASSIGNMENT(heptaFemasTradeSpi);
};
