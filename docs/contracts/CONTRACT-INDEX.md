...
| `hepta.module-manifest.v2` | target | [`modules/MODULE-MANIFEST-SPEC.md`](../modules/MODULE-MANIFEST-SPEC.md) | `../../docs/modules/module-manifest-schema-v3.json` | `hepta.documentation.control` | `hepta.management.control` |
