...
portfolio notional/PnL/drawdown, reconnect/refresh duration and network-policy
state still need individually bounded producers and behavior tests. Callback
queue lag/conflict, primary quote age, authoritative snapshot age and successful
post-fill Broker reconciliation duration are now produced and exported. A
