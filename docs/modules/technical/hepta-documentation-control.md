...
Applies to: `hepta.documentation.control` version `1.2.2` (current)
...
The manifest version is `1.2.2`. Contract or behavior changes that alter authority, state, failure or compatibility semantics require a governed version and registry update.
