...
| G-008 | Preview permits lack a complete authoritative lifecycle | P0 | server-issued opaque permit; expiry/generation binding; atomic consume; same-command replay; cross-command rejection | in progress |
