...
|---|---|---|---|---:|---|
| `M0` | Canonical Truth Consolidation | **in-progress** | — | 2 | one active documentation graph; no historical docs or aliases; stacked PR exact-head CI |
| `M1` | Documentation Control Plane | **in-progress** | M0 | 2 | generated views deterministic; registries cross-validated; evidence schema integrated |
| `M2` | Modular Runtime Foundation | **planned** | M1 | 2 | one target per module; no shared-migration source ownership; module-aware test impact |
